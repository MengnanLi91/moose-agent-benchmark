...
case_id: D2-COUPLED-JACOBIAN-001
title: "Missing Off-Diagonal Coupling Propagation"
case_kind: atomic
track: DIAG
subcategory: D2
physics_domains:
...
# Missing Off-Diagonal Coupling Propagation
...
This planned atomic case, **Missing Off-Diagonal Coupling Propagation**, exercises the D2 capability.

## What this case tests

**D2 — Causal-chain reconstruction.**

Causal mechanism, ordering, and direction.
...
- KSP convergence histories;
- SNES line-search failure;
- timestep reductions;
- terminal timestep failure.

## Required output

The agent must reconstruct the causal sequence.
...
- locating the exact MOOSE object;
- fixing the derivative.

## Isolation rationale

Upstream truth is supplied and downstream work is excluded so the case scores only D2.
...
- Planned public case (not created): `benchmark/public/cases/D2-COUPLED-JACOBIAN-001/`
- Planned private evaluator (not created): `benchmark/private/cases/D2-COUPLED-JACOBIAN-001/`
- Planned development fixtures (not created): `benchmark/example-submissions/D2-COUPLED-JACOBIAN-001*.json`
