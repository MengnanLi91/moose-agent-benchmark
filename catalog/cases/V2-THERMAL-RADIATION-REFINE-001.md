...
case_id: V2-THERMAL-RADIATION-REFINE-001
title: "Mesh Uncertainty in Radiative Surface Temperature"
case_kind: atomic
track: VERIFY
subcategory: V2
physics_domains:
...
# Mesh Uncertainty in Radiative Surface Temperature

## Benchmark purpose

This case is a planned atomic benchmark for **V2 — Discretization-error estimation**. It measures
...
This planned atomic case, **Mesh Uncertainty in Radiative Surface Temperature**, exercises the V2 capability.
...
Capabilities outside V2 are intentionally excluded from the score.

## Starting information

An accepted nonlinear radiation model is supplied. No exact solution is available.

One or more of:

- mean radiating-surface temperature;
- maximum radiating-surface temperature;
...
1. construct or execute a controlled mesh-refinement sequence;
2. demonstrate or assess asymptotic behavior;
3. estimate observed order;
4. estimate extrapolated QoI;
5. estimate spatial discretization uncertainty.
...
Upstream truth is supplied and downstream work is excluded so the case scores only V2.
...
- Planned public case (not created): `benchmark/public/cases/V2-THERMAL-RADIATION-REFINE-001/`
- Planned private evaluator (not created): `benchmark/private/cases/V2-THERMAL-RADIATION-REFINE-001/`
- Planned development fixtures (not created): `benchmark/example-submissions/V2-THERMAL-RADIATION-REFINE-001*.json`
