...
case_id: V2-POROUS-BREAKTHROUGH-001
title: "Temporal Discretization Uncertainty of Tracer Breakthrough"
case_kind: atomic
track: VERIFY
subcategory: V2
physics_domains:
...
# Temporal Discretization Uncertainty of Tracer Breakthrough
...
This planned atomic case, **Temporal Discretization Uncertainty of Tracer Breakthrough**, exercises the V2 capability.

## What this case tests

**V2 — Discretization-error estimation.**

Controlled temporal refinement and correct uncertainty analysis.
...
- accepted Darcy + tracer model;
- spatial mesh already demonstrated to be sufficiently resolved;
- fixed solver tolerances.

Either:

- breakthrough time; or
- outlet concentration at a specified time.

## Required output

The agent must vary only the timestep and estimate:

- temporal convergence order;
- extrapolated QoI;
- temporal discretization uncertainty.
...
Spatial discretization and nonlinear/linear solver error are controlled so the benchmark measures temporal discretization only.
...
- Planned public case (not created): `benchmark/public/cases/V2-POROUS-BREAKTHROUGH-001/`
- Planned private evaluator (not created): `benchmark/private/cases/V2-POROUS-BREAKTHROUGH-001/`
- Planned development fixtures (not created): `benchmark/example-submissions/V2-POROUS-BREAKTHROUGH-001*.json`
