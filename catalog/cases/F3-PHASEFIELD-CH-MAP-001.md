...
case_id: F3-PHASEFIELD-CH-MAP-001
title: "Map Split Cahn-Hilliard Formulation"
case_kind: atomic
track: FORM
subcategory: F3
physics_domains:
...
# Map Split Cahn-Hilliard Formulation
...
This planned atomic case, **Map Split Cahn-Hilliard Formulation**, exercises the F3 capability.

## What this case tests

**F3 — MOOSE object and coupling map.**

Term-to-object mapping correctness and coupling completeness.
...
- gold split Cahn-Hilliard weak form;
- concentration variable;
- chemical-potential variable;
- mobility definition;
- free-energy definition;
- domain and boundary labels;
- allowed Phase Field module object registry.

## Required output

The agent must map every weak-form term to valid MOOSE objects and identify:
...
- derivation of the Cahn-Hilliard equations;
- weak-form derivation;
- full input assembly.

## Isolation rationale

The mathematical formulation is fixed. The challenge is MOOSE-native decomposition of a multi-variable phase-field formulation.
...
- Planned public case (not created): `benchmark/public/cases/F3-PHASEFIELD-CH-MAP-001/`
- Planned private evaluator (not created): `benchmark/private/cases/F3-PHASEFIELD-CH-MAP-001/`
- Planned development fixtures (not created): `benchmark/example-submissions/F3-PHASEFIELD-CH-MAP-001*.json`
