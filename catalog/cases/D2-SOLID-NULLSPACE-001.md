...
case_id: D2-SOLID-NULLSPACE-001
title: "Rigid-Body Failure Chain"
case_kind: atomic
track: DIAG
subcategory: D2
physics_domains:
  - solid_mechanics
difficulty: L2
base_problem_id: LINEAR-ELASTICITY-BASE-001
status: planned
priority: normal
owner: null
reviewers: []
...
# Rigid-Body Failure Chain

## Benchmark purpose

This case is a planned atomic benchmark for **D2 — Causal-chain reconstruction**. It measures
...
This planned atomic case, **Rigid-Body Failure Chain**, exercises the D2 capability.

## What this case tests

**D2 — Causal-chain reconstruction.**

- correct causal nodes;
- correct ordering;
- correct direction.

Capabilities outside D2 are intentionally excluded from the score.

## Starting information

The planned benchmark will supply enough telemetry to establish:

1. unconstrained rigid-body mode;
2. singular or nearly singular linear system;
3. KSP failure;
4. SNES divergence.

## Required output

The agent must reconstruct the ordered causal chain.
...
- exact block/line localization;
- repair.

## Isolation rationale

The benchmark scores propagation reasoning rather than source localization.


## Case construction

Develop this synthetic case from `LINEAR-ELASTICITY-BASE-001`. Preserve the clean reference
...
- Planned public case (not created): `benchmark/public/cases/D2-SOLID-NULLSPACE-001/`
- Planned private evaluator (not created): `benchmark/private/cases/D2-SOLID-NULLSPACE-001/`
- Planned development fixtures (not created): `benchmark/example-submissions/D2-SOLID-NULLSPACE-001*.json`
